...
_unit addAction ["Platoon > Platoon Leader","[player,'pl'] call GW_Gear_Fnc_Handler;",bullShit,4];
...
_unit addAction ["<t color='#f383f7'>Exercise > Automatic Rifleman</t>","[player,'ear'] call GW_Gear_Fnc_Handler;",bullShit,4];
_unit addAction ["<t color='#f383f7'>Exercise > Asst. Gunner</t>","[player,'eag'] call GW_Gear_Fnc_Handler;",bullShit,4];
