	...
	if !(_errorCode) then {
		switch (_class) do {
			case "gearbox": {
				...
				[_unit, "rhs_weap_m4_carryhandle_mstock_grip3",10] call _fnc_AddObjectsCargo;
				[_unit, "rhs_weap_m4a1_carryhandle",10] call _fnc_AddObjectsCargo;
				[_unit, "CUP_arifle_Mk16_STD_FG_black",10] call _fnc_AddObjectsCargo;
				[_unit, "arifle_Mk20C_plain_F",10] call _fnc_AddObjectsCargo;
				[_unit, "arifle_TRG20_F",10] call _fnc_AddObjectsCargo;
				[_unit, "rhs_weap_mk18_KAC_bk",10] call _fnc_AddObjectsCargo;
				[_unit, "CUP_arifle_HK416_CQB_Black",10] call _fnc_AddObjectsCargo;
				[_unit, "CUP_arifle_L85A2_G",10] call _fnc_AddObjectsCargo;
				if (GVARMAIN(mod_ACE3)) then {
					[_unit, _flashBang, 50] call _fnc_AddObjectsCargo;
