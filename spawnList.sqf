...
switch (_case) do {
	...
	case 13:{
		...
		if ((random 1) >= 0.5) then {
			[[[[3351.86,13207.1,0],230,[]],[[3351.79,13211.8,0],231,[]]],[],[[[3321.05,13185.3,0],[[0,"Move"]]],[[3324.26,13173.3,0],[[0,"Move"]]],[[3317.43,13189.3,0],[[0,"Move"]]],[[3349.8,13210,0],[[0,"Cycle"]]]]] call GW_Common_fnc_spawnGroup;
		} else {
			[[[[3375.62,13197.6,0],230,[]],[[3375.55,13202.3,0.236685],231,[]]],[],[[[3361.59,13188.3,0],[[0,"Move"]]],[[3359.76,13166.5,-2.38419e-007],[[0,"Move"]]],[[3362.08,13187.8,0],[[0,"Move"]]],[[3374.1,13200.1,0],[[0,"Cycle"]]]]] call GW_Common_fnc_spawnGroup;
		};

		//// Random Patrol 2
		if ((random 1) >= 0.5) then {
			[[[[3416.21,13226,0],230,[]],[[3416.14,13230.7,4.76837e-007],231,[]]],[],[[[3410.3,13215.3,0],[[0,"Move"]]],[[3396.13,13202.4,0],[[0,"Move"]]],[[3393.23,13213.2,0],[[0,"Move"]]],[[3414.15,13229,0],[[0,"Cycle"]]]]] call GW_Common_fnc_spawnGroup;
		} else {
			[[[[3398.28,13129.4,0],230,[]],[[3398.21,13134.1,0],231,[]]],[],[[[3383.02,13113.3,0],[[0,"Move"]]],[[3351.67,13141,4.76837e-007],[[0,"Move"]]],[[3379.4,13117.3,0],[[0,"Move"]]],[[3396.22,13132.4,0],[[0,"Cycle"]]]]] call GW_Common_fnc_spawnGroup;
		};

		//// Random Patrol 3
		if ((random 1) >= 0.5) then {
			[[[[3433.57,13180.8,0],312,[]],[[3438.25,13181.5,0],313,[]]],[],[[[3427.58,13200.4,0],[[0,"Move"]]],[[3414.51,13213.5,0],[[0,"Move"]]],[[3429.42,13201.8,0],[[0,"Move"]]],[[3436.24,13183.2,0],[[0,"Cycle"]]]]] call GW_Common_fnc_spawnGroup;

		} else {

			[[[[3466.79,13289.5,0],230,[]],[[3466.72,13294.2,2.38419e-007],231,[]]],[],[[[3446.42,13266,0],[[0,"Move"]]],[[3456.06,13243.2,0.581872],[[0,"Move"]]],[[3439.91,13260.3,0],[[0,"Move"]]],[[3464.73,13292.5,0],[[0,"Cycle"]]]]] call GW_Common_fnc_spawnGroup;
		};

		//// Random Patrol 4
		if ((random 1) >= 0.5) then {
			[[[[3479.32,13214.4,0],336,[]],[[3483.87,13213.1,0.516469],337,[]]],[],[[[3492.87,13247.3,0.587252],[[0,"Move"]]],[[3471.54,13264.7,-2.38419e-007],[[0,"Move"]]],[[3494.22,13245.4,0],[[0,"Move"]]],[[3482.74,13215.5,0],[[0,"Cycle"]]]]] call GW_Common_fnc_spawnGroup;
		} else {
			[[[[3525.79,13271.5,0],308,[]],[[3530.39,13272.6,0],308,[]]],[],[[[3499.03,13316.6,0],[[0,"Move"]]],[[3476.28,13302.7,0],[[0,"Move"]]],[[3498.79,13319.2,0],[[0,"Move"]]],[[3528.25,13274.2,0],[[0,"Cycle"]]]]] call GW_Common_fnc_spawnGroup;
		};

		//// Random Patrol 5
		if ((random 1) >= 0.5) then {
			[[[[3553.87,13340.9,4.76837e-007],230,[]],[[3553.8,13345.6,9.53674e-007],231,[]]],[],[[[3518.3,13392.2,0],[[0,"Move"]]],[[3508.65,13377.4,0],[[0,"Move"]]],[[3529.4,13357.8,0],[[0,"Move"]]],[[3551.81,13343.9,4.76837e-007],[[0,"Cycle"]]]]] call GW_Common_fnc_spawnGroup;
		} else {
			[[[[3496.24,13344.3,0.158467],230,[]],[[3496.17,13349,0.158468],231,[]]],[],[[[3492.85,13334.2,0.804936],[[0,"Move"]]],[[3481.08,13310.6,0],[[0,"Move"]]],[[3463.53,13331.1,0.783257],[[0,"Move"]]],[[3494.18,13347.3,1.44506],[[0,"Cycle"]]]]] call GW_Common_fnc_spawnGroup;
		};

		//// Random Patrol 6
		if ((random 1) >= 0.5) then {
			[[[[3449.26,13297.1,0],230,[]],[[3449.19,13301.8,0],231,[]]],[],[[[3412.97,13260.6,0],[[0,"Move"]]],[[3365.63,13214.6,0.527066],[[0,"Move"]]],[[3410.91,13258.8,0],[[0,"Move"]]],[[3447.2,13300,0],[[0,"Cycle"]]]]] call GW_Common_fnc_spawnGroup;
		} else {
			[[[[3525.69,13289.7,0],230,[]],[[3525.63,13294.4,2.38419e-007],231,[]]],[],[[[3494.88,13267.9,2.38419e-007],[[0,"Move"]]],[[3385.67,13160.2,0.554751],[[0,"Move"]]],[[3497.16,13264.8,0],[[0,"Move"]]],[[3523.63,13292.6,2.38419e-007],[[0,"Cycle"]]]]] call GW_Common_fnc_spawnGroup;
		};

		//// Patrol 7
		[[[[3557.94,13354.4,0],230,[]],[[3557.87,13359.1,0],231,[]]],[],[[[3540.51,13360.3,0],[[0,"Move"]]],[[3548.49,13389.4,0],[[0,"Move"]]],[[3575.58,13359.7,4.76837e-007],[[0,"Move"]]],[[3559.47,13357.1,0],[[0,"Cycle"]]]]] call GW_Common_fnc_spawnGroup;


		//// Random Static 1
		if ((random 1) >= 0.5) then {
			[[[[3366.76,13162.8,0.524243],302,"UP",[]],[[3354.45,13160.7,0.589838],230,"UP",[]],[[3351.56,13188.8,0.104853],152,"UP",[]]],[],[]] call GW_Common_fnc_spawnGroup;
		} else {
			[[[[3345.78,13185.1,0.138967],137,"UP",[]],[[3362.36,13196.6,0.343809],131,"UP",[]],[[3376.01,13178.6,3.91112],252,"UP",[]]],[],[]] call GW_Common_fnc_spawnGroup;
		};

		//// Random Static 2
		if ((random 1) >= 0.5) then {
			[[[[3391.86,13187.9,0.481394],320,"UP",[]],[[3426.55,13214.6,3.87321],259,"UP",[]],[[3398.17,13232.2,0.505161],138,"UP",[]]],[],[]] call GW_Common_fnc_spawnGroup;
		} else {
			[[[[3390.63,13203,4.20617],59,"UP",[]],[[3402.23,13227.7,3.98352],146,"UP",[]],[[3426.22,13226.7,0.565248],231,"UP",[]]],[],[]] call GW_Common_fnc_spawnGroup;
		};

		//// Random Static 3
		if ((random 1) >= 0.5) then {
			[[[[3465.62,13261.6,4.18388],309,"UP",[]],[[3437.57,13238,0.275065],231,"UP",[]],[[3441.32,13267.9,0.309354],117,"UP",[]]],[],[]] call GW_Common_fnc_spawnGroup;
		} else {
			[[[[3441.67,13247.6,3.76654],0,"UP",[]],[[3435.5,13260.2,4.43506],125,"UP",[]],[[3461.63,13279.4,0.874364],23,"UP",[]]],[],[]] call GW_Common_fnc_spawnGroup;
		};

		//// Random Static 4
		if ((random 1) >= 0.5) then {
			[[[[3510.18,13314.4,0.485594],247,"UP",[]],[[3496.25,13297.4,0],298,"UP",[]],[[3470.05,13308.1,0.523811],132,"UP",[]]],[],[]] call GW_Common_fnc_spawnGroup;
		} else {
			[[[[3478.95,13320.8,0.53375],115,"UP",[]],[[3488.22,13297.1,0.373469],298,"UP",[]],[[3510.53,13314.7,0.492205],238,"UP",[]]],[],[]] call GW_Common_fnc_spawnGroup;
		};

		//// Random Static 5
		if ((random 1) >= 0.5) then {
			[[[[3551.59,13397.2,4.19013],182,"UP",[]],[[3566.63,13380.8,0.41229],279,"UP",[]],[[3534.64,13381.3,4.25285],237,"UP",[]],[[3516.75,13372.4,4.33917],221,"UP",[]],[[3534.96,13352.3,4.05974],289,"UP",[]]],[],[]] call GW_Common_fnc_spawnGroup;
		} else {
			[[[[3518.77,13381.9,0.63707],91,"UP",[]],[[3540.82,13402.4,4.34417],226,"UP",[]],[[3557.54,13388.9,0.54197],233,"UP",[]],[[3548.1,13366.5,0],147,"UP",[]],[[3534.12,13351.8,4.19708],238,"UP",[]]],[],[]] call GW_Common_fnc_spawnGroup;
		};
